...
public interface IDataSourceManager {
	 ...
	 * @param item
	 * @param userCtx The user context of the person trying to save the item, used
	 *                 to know whether the source should save the item.
	 * @return Whether the operation was successful
	 */
	public boolean saveItem(QAModel item, UserContext userCtx);
